function Get-IPST_deviceManagement_intents {
  ...
  param (
    ...
    [Parameter(ParameterSetName='Assignment',Mandatory=$false,Position=0)][switch]$Assignment,
    ...
    [Parameter(ParameterSetName='Settings',Mandatory=$false,Position=0)][switch]$Settings,
    ...
    [Parameter(ParameterSetName='DeviceSettingStateSummaries',Mandatory=$false,Position=0)][switch]$DeviceSettingStateSummaries,
    # https://docs.microsoft.com/en-us/graph/api/intune-deviceintent-devicemanagementintentdevicestate-list?view=graph-rest-beta
    [Parameter(ParameterSetName='DeviceStates',Mandatory=$false,Position=0)][switch]$DeviceStates,
    ...
    [Parameter(ParameterSetName='DeviceStateSummary',Mandatory=$false,Position=0)][switch]$DeviceStateSummary,
    ...
    [Parameter(ParameterSetName='Categories',Mandatory=$false,Position=0)][switch]$Categories,
    # https://docs.microsoft.com/en-us/graph/api/intune-deviceintent-devicemanagementintentuserstate-list?view=graph-rest-beta
    [Parameter(ParameterSetName='UserStates',Mandatory=$false,Position=0)][switch]$UserStates,
    ...
    [Parameter(ParameterSetName='UserStateSummary',Mandatory=$false,Position=0)][switch]$UserStateSummary,
