function Get-IPST_deviceAppManagement_targetedManagedAppConfigurations {
  <#
  .SYNOPSIS
  ...
  .EXAMPLE
    PS> Get-IPST_deviceAppManagement_targetedManagedAppConfigurations -Id 00000000-0000-0000-0000-000000000000
  .LINK
